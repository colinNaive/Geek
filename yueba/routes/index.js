...
module.exports = function(app) {
  ...
  app.get('/', function (req, res) {
    ...
    Post.getTen(activityId, page, function (err, doc, total) {
        ...
        // console.log("doc.topics="+doc.topics);
        console.log("page="+page);
        console.log("doc.group="+doc.group);
        console.log("doc.activityAdr="+doc.activityAdr);
        console.log("doc.activityName="+doc.activityName);
        console.log("doc.activityId="+doc.activityId);
        console.log("doc.activityTime="+doc.activityTime);
        ...
        console.log("doc_topics_length="+doc.topics.length);
        res.render('index', {
          posts: doc.topics,
          page: page,
          isFirstPage: (page - 1) == 0,
          isLastPage: ((page - 1) * 5 + doc.topics.length) == total,
          user: user,
          group: doc.group,
