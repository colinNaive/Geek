    ...
    function Scroller(elem, settings) {
        ...
        */
        that.show = function (prevAnim) {
            ...
            var html = '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="diag_header_s">添加定时</div><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (s.headerText ? '<div class="dwv"></div>' : ''));
			...
			html+='<div class="week"><div class="weekday"><input id="check_a" class="checkbox_a cb" type="checkbox"><label for="check_a" class="weekday_text weekday_a_text">日</label></div><div class="weekday"><input id="check_b" class="checkbox_b cb" type="checkbox"><label for="check_b" class="weekday_text weekday_b_text">一</label></div><div class="weekday"><input id="check_c" class="checkbox_c cb" type="checkbox"><label for="check_c" class="weekday_text weekday_c_text">二</label></div><div class="weekday"><input id="check_d" class="checkbox_d cb" type="checkbox"><label for="check_d" class="weekday_text weekday_d_text">三</label></div><div class="weekday"><input id="check_e" class="checkbox_e cb" type="checkbox"><label for="check_e" class="weekday_text weekday_e_text">四</label></div><div class="weekday"><input id="check_f" class="checkbox_f cb" type="checkbox"><label for="check_f" class="weekday_text weekday_f_text">五</label></div><div class="weekday"><input id="check_g" class="checkbox_g cb" type="checkbox"><label for="check_g" class="weekday_text weekday_g_text">六</label></div></div>'
           	html+='<div class="box_s"><section class="box1_s"><input id="check_1_s" class="checkbox_s" name="check_s" type="checkbox" checked><label for="check_1_s" class="trigger_s"></label></section><section class="box2_s"><img class="button_set" id="time_set_ok" src="imgs/extend_ok.png"/></section></div>';
            dw = $(html);
            scrollToPos();
            ...
            if (s.display != 'inline') {
				...
				//点击checkbox
                that.tap($('.checkbox_s', dw), function () {
					if (!!$('.checkbox_s').attr("checked")) {
						switchonoff="1";
					}else{
						switchonoff="2";
					}
                ...
                //点击ok
                that.tap($('#time_set_ok', dw), function () {
                	var tempHEX="";
                	$('.cb').each(function(){
					...
					var str="";
					for(var i=0;i<tempHEX.length;i++){
					str+=tempHEX.charAt(tempHEX.length-i-1);
					}
					str="1"+str;
					console.log("result="+str);
                    if (that.hide(false, 'set') !== false) {
                       elm.val(v+"@"+str+"@"+switchonoff).trigger('change');
                    }
                });
                if (s.button3) {
